...
namespace LMS
{
    public partial class Update_M_payment : Form
    {
        ...
        private void Update_M_payment_Load(object sender, EventArgs e)
        {
        ...
        private void Add_button_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        SqlCommand cmd = new SqlCommand("Update Membership_Payment set Payment_Amount=@Payment_Amount,User_ID=@User_ID,Payment_Date=@Payment_Date where Membership_ID=@Membership_ID", conn);
                        ...
                        cmd.ExecuteNonQuery();
                        MessageBox.Show("Membership Payment Update Completed", "ADD", MessageBoxButtons.OK, MessageBoxIcon.Information);
