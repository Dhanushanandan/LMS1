...
namespace LMS
{
    public partial class A_D_New_fine : Form
    {
        ...
        private void A_D_New_fine_Load(object sender, EventArgs e)
        {
        ...
        private void Add_button_Click(object sender, EventArgs e)
        {
            try
            {
                if (ID_textBox.Text == "" || name_textBox.Text == "" || Damaged_textBox.Text == "")
                {
                ...
                else
                {
                    ...
                    {
                        conn.Open();
                        SqlCommand cmd = new SqlCommand("insert into Damaged_Book values(@Damaged_ID,@User_ID,@Book_ID,@Damaged_Fine)", conn);
