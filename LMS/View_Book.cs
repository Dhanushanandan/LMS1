...
namespace LMS
{
    public partial class View_Book : Form
    {
        ...
        private void Search_button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("Invalid input insert a Book ID OR Book Name OR Book Author Name", "Search_button", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        Search_textBox.Clear();
                        Search_textBox.Focus();
                        conn.Close();
                    }
        ...
        private void All_View_button_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd1 = new SqlCommand("Select * from Book_Details", conn);
                SqlDataAdapter adapter1 = new SqlDataAdapter(cmd1);
                DataTable dataTable1 = new DataTable();
                adapter1.Fill(dataTable1);
                dataGridView1.DataSource = dataTable1;
