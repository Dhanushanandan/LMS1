...
namespace LMS
{
    public partial class Update_Membership : Form
    {
        ...
        private void Update_Membership_Load(object sender, EventArgs e)
        {
        ...
        private void Add_button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        SqlCommand cmd = new SqlCommand("Update Membership_details set Membership=@Membership Where User_ID=@User_ID AND Updated_Date=@Updated_Date AND End_Date=@End_Date", conn);
                        ...
                        cmd.ExecuteNonQuery();
                        MessageBox.Show("Membership Update Completed", "ADD", MessageBoxButtons.OK, MessageBoxIcon.Information);
