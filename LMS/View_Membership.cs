...
namespace LMS
{
    public partial class View_Membership : Form
    {
        //invoking the database connecting using a seperate class with creating an object
        SqlConnection conn = new Database().DBConnect();
        public View_Membership()
        {
            InitializeComponent();
        }

        private void View_Membership_Load(object sender, EventArgs e)
        {
        ...
        private void All_View_button_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd1 = new SqlCommand("Select * from Membership_details", conn);
        ...
        private void Search_button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd1 = new SqlCommand("Select * from Membership_details Where User_ID=@User_ID", conn);
